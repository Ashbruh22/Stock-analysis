...
**BCSI is at github.com/Ashbruh22/Stock-analysis. MIT licensed. Five-dimension composite scoring with confidence as a first-class output, ML distress prediction with SHAP explanations, real-time prices, multi-user watchlists. Self-hosted on a $7/mo VPS.**
