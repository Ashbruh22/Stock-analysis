...
<p align="center">
  ...
  &nbsp;·&nbsp;
  <a href="https://render.com/deploy?repo=https://github.com/Ashbruh22/Stock-analysis"><img alt="Deploy to Render" src="https://render.com/images/deploy-to-render-button.svg" height="22"></a>
</p>
...
```bash
git clone https://github.com/Ashbruh22/Stock-analysis.git
cd bcsi
...
MIT. Use it for anything you want. If it makes you money or saves your team time, [star the repo](https://github.com/Ashbruh22/Stock-analysis) — that's how this stays alive.
